...
class Pelanggaran extends CI_Controller {
	...
	var $pk    = 'kd_pelanggaran';
	var $field = array('kd_pelanggaran','nm_pelanggaran');

	//param for view
	var $view_list = array('No','Nama Pelanggaran','Action');
	...
	{				
		$data['breadcump'] 		= "Pelanggaran";
		$data['title_page']		= "Pelanggaran";
		$data['content_view']	= "pelanggaran/index";
	...
	public function list_data()
	{
		...
		foreach ($list as $regulasi) {
			...
			$row[] = '<a  href="#" title="Edit" onclick="edit_data('."'".$regulasi->kd_pelanggaran."'".')" >
						<i class="fa fa-pencil"></i> Edit
					  </a> &nbsp; |		 
					  <a class="delete" href="#" title="Delete" onclick="delete_data('."'".$regulasi->kd_pelanggaran."'".')" >
	...
	public function ajax_update()
	{
		...
		$update =  $this->crud_model->update($this->table,$this->pk,$this->input->post('kd_pelanggaran'),$data);
