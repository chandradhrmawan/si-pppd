...
<script type="text/javascript">
 ...
 const doPrint = () => {
  ...
  const printPrev = () => {
    ...
    $.ajax({
        url : "<?php echo site_url('laporan/Tugas/listData')?>?tgl_awal="+tgl_awal+"&tgl_akhir="+tgl_akhir,
        type: "GET",
        dataType: "JSON",
  ...
  const exportExcel = () => {
    ...
    let url = "<?php echo site_url('laporan/Tugas/exportExcel')?>?id_jenis="+id_jenis+"&id_merk="+id_merk+"&model="+model
